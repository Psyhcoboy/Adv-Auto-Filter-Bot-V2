...
async def auto_filter(bot, update):
    ...
    if filters:
        ...
        await bot.send_message(
            ...
            text=f"<b>🚫നിങ്ങൾ ചോദിച്ച സിനിമ എനിക്ക് കണ്ടെത്താൻ ആയില്ല ഒരുപക്ഷെ സ്പെല്ലിങ് തെറ്റവും. ശരിയായ സ്പെല്ലിങ് ഗൂഗിളിൽ നോക്കി വീണ്ടും ട്രൈ ചെയ്യുക. എന്നിട്ടും കിട്ടിയില്ലേൽ ആ സിനിമ റിലീസ് ആയിട്ടുണ്ടോ എന്ന് ഉറപ്പാക്കുക.🚫</b>",
            parse_mode="html",
